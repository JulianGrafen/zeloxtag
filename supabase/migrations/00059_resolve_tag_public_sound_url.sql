-- =============================================================================
-- ZeloxTag · Public QR resolver exposes engine sound for public showcases
-- Migration: 00059_resolve_tag_public_sound_url
-- =============================================================================
-- Guests scanning /v/{tagUuid} use resolve_tag_by_uuid; without sound_url the
-- public showcase cannot render the engine soundcheck control.
...
begin
  ...
  select jsonb_build_object(
    ...
    'sound_url', case when v.is_public = true then v.sound_url else null end,
