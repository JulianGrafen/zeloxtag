-- =============================================================================
-- ZeloxTag · Public slug resolver includes engine sound path
-- Migration: 00058_public_slug_resolver_sound_url
-- =============================================================================
-- Without sound_url, public share links could not expose engine soundcheck URLs.
