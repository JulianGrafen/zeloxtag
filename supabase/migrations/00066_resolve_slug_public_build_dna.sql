-- =============================================================================
-- ZeloxTag · Public slug resolver includes cached Build DNA
-- Migration: 00066_resolve_slug_public_build_dna
-- =============================================================================
...
comment on function public.resolve_public_vehicle_by_slug(text) is
  'Public share-link resolver by vehicles.public_slug — only when is_public = true (includes Build DNA cache).';
