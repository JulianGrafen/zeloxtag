  ...
  return (
    ...
    >
      ...
      <p className="text-[0.82rem] leading-relaxed text-[color:var(--vd-muted)]">
        {isPublic
          ? "Das Fahrzeugbild aus den Fahrzeugdaten, Galerie-Fotos und das Leistungsdiagramm sind für alle Besucher öffentlich sichtbar."
          : "Wenn du dein öffentliches Profil aktivierst, sind das Fahrzeugbild aus den Fahrzeugdaten, Galerie-Fotos und das Leistungsdiagramm für alle Besucher sichtbar."}
      </p>
    </div>
  );
}
