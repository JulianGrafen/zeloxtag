...
export function StickyPaywallCta({
  ...
  return (
    <div
      className={cn(
        "z-20 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))]",
        fixed
          ? "fixed inset-x-0 bottom-0 border-t border-[color:var(--vd-border)] bg-[color:var(--vd-surface)]/95 pt-2 shadow-[0_-8px_24px_rgba(0,0,0,0.08)] backdrop-blur-xl"
          : "shrink-0 bg-[color:var(--vd-surface)]/95 pt-0.5 backdrop-blur-xl",
      )}
    >
