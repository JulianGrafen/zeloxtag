      ...
      <ol className="relative space-y-0">
        {nodes.map((node, index) => (
          ...
          >
            ...
            <span
              className={cn(
                "relative z-10 inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[color:var(--vd-border)] bg-[color:var(--vd-surface)] text-[color:var(--vd-text)]",
              )}
              aria-hidden
            >
